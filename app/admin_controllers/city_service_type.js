...
exports.genetare_city_type_excel = function (req, res, next) {
    if (typeof req.session.userid != 'undefined') {
        ...
        City_type.aggregate([lookup, unwind, lookup1, unwind1, lookup2, unwind2, search, filter, sort]).then((array) => { 
            ...
            sheet1.set(2, 1, req.__('title_country_business'));
            sheet1.set(3, 1, req.__('title_city'));
            sheet1.set(4, 1, req.__('title_city_business'));
            sheet1.set(5, 1, req.__('title_type'));
            sheet1.set(6, 1, req.__('title_type_business'));
            sheet1.set(7, 1, req.__('title_bussiness'));
            ...
            array.forEach(function (data, index) {
                ...
                if (data.country_detail.isBusiness == 1) {
                    sheet1.set(2, index + 2, req.__('title_on'));
                } else {
                    sheet1.set(2, index + 2, req.__('title_off'));
                }
                ...
                if (data.type_detail.is_business == 1) {
                    sheet1.set(6, index + 2, req.__('title_on'));
                } else {
                    sheet1.set(6, index + 2, req.__('title_off'));
                }
                if (data.is_business == 1) {
                    sheet1.set(7, index + 2, req.__('title_on'));
                } else {
                    sheet1.set(7, index + 2, req.__('title_off'));
                }
                ...
                if (index == array.length - 1) {
                    workbook.save(function (err) {
                        if (err)
                        {
                            ...
                            var url = 'https://' + req.get('host') + "/xlsheet/" + time + "_city_type.xlsx"
                            res.json(url);
                            setTimeout(function () {
