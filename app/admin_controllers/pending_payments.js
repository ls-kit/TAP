...
exports.pending_payment = function (req, res, next) {
    ...
    if (typeof req.session.userid != 'undefined') {
        ...
        Trip_history.aggregate([lookup, unwind, search, filter, is_pending, count], function (err, array) {
            if (!array || array.length == 0)
            {
                ...
                delete message;
                    ...
                    Trip_history.aggregate([lookup, unwind, search, filter, sort, is_pending, skip, limit], function (err, array) {
...
exports.pending_payment_excel = function (req, res, next) {
    ...
    if (typeof req.session.userid != 'undefined') {
        ...
        Trip_history.aggregate([lookup, unwind, search, filter, sort, is_pending], function (err, array) {
            Settings.findOne({}, function (err, settingData) {
                ...
                sheet1.set(3, 1, req.__('title_user_name'));
                sheet1.set(4, 1, req.__('title_email'));
                sheet1.set(5, 1, req.__('title_number_of_cards'));
                sheet1.set(6, 1, req.__('title_payment_error'));
                sheet1.set(7, 1, req.__('title_payment_message'));
                sheet1.set(8, 1, req.__('title_charged'));
                    ...
                    if (index == array.length - 1) {
                        workbook.save(function (err) {
                            if (err)
                            {
                                ...
                                var url = 'https://' + req.get('host') + "/xlsheet/" + time + "_pending_payment.xlsx"
                                res.json(url);
                                setTimeout(function () {
...
exports.is_paid = function (req, res, next) {
    ...
    if (typeof req.session.userid != 'undefined') {
        ...
        Trip_history.findByIdAndUpdate(query, {is_pending_payments: 0, is_paid: 1}, function (err, user) {
