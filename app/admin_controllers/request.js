...
exports.list = function (req, res, next) {
    ...
    if (typeof req.session.userid != 'undefined') {
        ...
        Table.aggregate([filter, condition, trip_condition, payment_condition, status_condition, lookup, unwind, lookup1, lookup2, unwind2, lookup3, unwind3, search, count]).then((array) => { 
            ...
            } else
            {
                ...
                Table.aggregate([filter, condition, trip_condition, payment_condition, status_condition, lookup, unwind, lookup1, lookup2, unwind2, lookup3, unwind3, search, sort, skip, limit]).then((array) => { 
...
exports.genetare_request_excel = function (req, res, next) {
    ...
    if (typeof req.session.userid != 'undefined') {
        ...
        var trip_condition = {$match: {is_schedule_trip: {$eq: false}}}
        Trip_history.aggregate([filter, condition, trip_condition, lookup, unwind, lookup1, lookup2, unwind2, lookup3, unwind3, search, sort]).then((array) => { 
                ...
                if (index == array.length - 1) {
                    workbook.save(function (err) {
                        if (err)
                        {
                            ...
                            var url = 'https://' + req.get('host') + "/xlsheet/" + time + "_trip.xlsx"
                            res.json(url);
                            setTimeout(function () {
...
exports.trip_refund_amount = function (req, res, next) {
    ...
    if (typeof req.session.userid != 'undefined') {
        ...
        Trip_history.findOne({_id: req.body.id}).then((trip) => { 
