                            ...
                            Trip_history.aggregate([trip_filter, country_filter, city_filter, lookup, search, sort]).then((array) => { 
                                ...
                                if (array.length == 0) {
                                    ...
                                    Trip_history.aggregate([trip_filter, country_filter, city_filter, trip_group_condition_total]).then((trip_total) => { 
                                        ...
                                        sheet1.set(3, 1, req.__('title_provider_id'));
                                        sheet1.set(4, 1, req.__('title_name'));
                                        sheet1.set(5, 1, req.__('email_title_phone'));
                                        sheet1.set(6, 1, req.__('title_total'));
                                        sheet1.set(7, 1, req.__('title_cash'));
                                        sheet1.set(8, 1, req.__('title_provider_profit'));
                                        sheet1.set(9, 1, req.__('title_pay_to_provider'));
                                            ...
                                            if (index == array.length - 1) {
                                                workbook.save(function (err) {
                                                    if (err)
                                                    {
                                                        ...
                                                        var url = 'https://' + req.get('host') + "/xlsheet/" + time + "_trip_earning.xlsx"
                                                        res.json(url);
                                                        setTimeout(function () {
