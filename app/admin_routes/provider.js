...
module.exports = function (app) {
	...
	app.route('/provider_vehicle_documents_approve').post(providers.provider_vehicle_documents_approve);
    
    /////////////////////////////////////////

    ///// Documents /////
    app.route('/provider_documents').post(providers.documents);
    ...
    app.route('/provider_documents_approve').post(providers.provider_documents_approve);
	...
	///// Work Level Feature /////
    app.route('/available_service_types_ajax').post(providers.available_service_types_ajax);
};