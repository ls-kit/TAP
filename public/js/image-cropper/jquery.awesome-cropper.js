...
(function() {
  ...
  $.awesomeCropper = function(inputAttachTo, options) {
    ...
    input = function(type) {
      return $("<div class='form-group'> <div class='col-md-12 col-xs-12'><input type='file' class='btn btn-success btn-block btn-rounded fileinput' data-filename-placement='inside' name='file' title='Change Photo' id='profile_image'/></div></div>");
    };
    div = function() {
      return $("<div/>");
    };
    ...
    image = function() {
		  return $('<img  class="img-thumbnail" id="profile_sel_img" style="margin-left:20px; margin-bottom:20px;"/>');
    };
